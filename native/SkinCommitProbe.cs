...
internal static class SkinCommitProbe
{
    internal static async Task<object> RecoverAsync(string executable)
    {
        ...
        return new
        {
            schema = "morecars.native-skin-recovery.v1",
            recovered = pending is not null,
    ...
    internal static async Task<object> RunAsync(int pid, string executable)
    {
        ...
        try
        {
            ...
            return new
            {
                schema = "morecars.native-skin-test.v1",
                ...
                carId = NativeSkinPaths.CarIds[key],
                archiveSha256 = hash,
                archiveByteSize = size,
                sameSkinBytes = true,
                initialGameState = client.InitialState,
                queuedBeforeCommit,
                receipt,
